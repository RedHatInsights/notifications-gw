...
import com.redhat.cloud.notifications.RbacServer;
...
public class RbacFilter implements ContainerRequestFilter {
  ...
  public void filter(ContainerRequestContext requestContext) throws IOException {
    ...
    if (path.startsWith("/admin") ||path.startsWith("/sample")) {
      return;
    }
  ...
  RbacRaw getRbacInfo(String xrhidHeader)  {
    RbacRaw result;
    result = rbac.getRbacInfo("policies", xrhidHeader); // TODO what app?
    return result;
  }
}
